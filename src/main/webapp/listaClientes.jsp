...
<html>
    ...
    <br/>
    <a href="index.jsp"><button type="button" class="btn btn-outline-secondary">Voltar</button>
        <a href="cadastrarCliente.jsp"><button type="button" class="btn btn-primary">Cadastrar Clientes</button></a>
